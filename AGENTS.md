...
## О проекте
Kollocol - iOS приложение для прохождения онлайн викторин. Викторины существуют двух типов: синхронные (преподаватель сам решает когда показать следующий вопрос), и асинхронные (ставится дедлайн и люди решают квиз в любое время)
